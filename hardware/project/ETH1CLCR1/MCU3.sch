...
AR Path="/5DF38F82/5E29D787" Ref="#PWR0906"  Part="1" 
F 0 "#PWR0906" H 7550 6700 50  0001 C CNN
...
AR Path="/5DF38F82/5E29D7A6" Ref="R903"  Part="1" 
F 0 "R903" H 13370 6496 50  0000 L CNN
...
AR Path="/5DF38F82/5E29D7AE" Ref="#PWR0913"  Part="1" 
F 0 "#PWR0913" H 13300 6400 50  0001 C CNN
...
AR Path="/5DF38F82/5E74C1B5" Ref="#PWR0912"  Part="1" 
F 0 "#PWR0912" H 9900 10350 50  0001 C CNN
...
AR Path="/5DF38F82/5E7594BE" Ref="C910"  Part="1" 
F 0 "C910" H 15115 5596 50  0000 L CNN
...
AR Path="/5DF38F82/5E7594C4" Ref="C911"  Part="1" 
F 0 "C911" H 15615 5596 50  0000 L CNN
...
U 1 1 5E7616EE
P 14150 5750
F 0 "R904" H 14080 5704 50  0000 R CNN
...
AR Path="/5DF38F82/5E76F046" Ref="R901"  Part="1" 
F 0 "R901" H 9020 10046 50  0000 L CNN
...
AR Path="/5DF38F82/5E76F04C" Ref="R902"  Part="1" 
F 0 "R902" H 9370 10046 50  0000 L CNN
...
$Comp
L ETH1CLCR1:DGNDF #PWR0909
U 1 1 5E77122F
P 8000 10600
F 0 "#PWR0909" H 8000 10350 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CLCR1:DGNDF #PWR0907
U 1 1 5E7714DB
P 7550 10600
F 0 "#PWR0907" H 7550 10350 50  0001 C CNN
...
U 1 1 5E776A2B
P 13400 5650
F 0 "C908" V 13148 5650 50  0000 C CNN
...
$Comp
L ETH1CLCR1:DGNDF #PWR0917
U 1 1 5E77E2A8
P 15250 5800
F 0 "#PWR0917" H 15250 5550 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CLCR1:DGNDF #PWR0914
U 1 1 5E77E4B3
P 13600 5650
F 0 "#PWR0914" H 13600 5400 50  0001 C CNN
...
U 1 1 5E7B49DC
P 14150 6150
F 0 "C909" H 14265 6196 50  0000 L CNN
...
AR Path="/5DF38F82/5E7BFF4D" Ref="#PWR0916"  Part="1" 
F 0 "#PWR0916" H 14150 6050 50  0001 C CNN
...
U 1 1 5E0C93AD
P 950 10500
F 0 "C901" H 1065 10546 50  0000 L CNN
...
U 1 1 5E0CAC52
P 1450 10500
F 0 "C902" H 1565 10546 50  0000 L CNN
...
U 1 1 5E0CAEC5
P 1950 10500
F 0 "C903" H 2065 10546 50  0000 L CNN
...
U 1 1 5E0CB1FC
P 2450 10500
F 0 "C904" H 2565 10546 50  0000 L CNN
...
U 1 1 5E0CB50D
P 2950 10500
F 0 "C905" H 3065 10546 50  0000 L CNN
...
U 1 1 5E0CB78E
P 3450 10500
F 0 "C906" H 3565 10546 50  0000 L CNN
...
$Comp
L ETH1CLCR1:DGNDF #PWR0902
U 1 1 5E107792
P 2200 10750
F 0 "#PWR0902" H 2200 10500 50  0001 C CNN
...
U 1 1 5DEC46E0
P 4100 10500
F 0 "C907" H 4215 10546 50  0000 L CNN
...
$EndComp
$Comp
L ETH1CLCR1:DGNDF #PWR0904
U 1 1 5DEC5F6E
P 4100 10750
F 0 "#PWR0904" H 4100 10500 50  0001 C CNN
...
Wire Wire Line
	1850 5650 1900 5650
$Comp
L ETH1CLCR1:+3.3VF #PWR0901
U 1 1 5E94700D
P 2200 10250
F 0 "#PWR0901" H 2200 10100 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CLCR1:+3.3VF #PWR0903
U 1 1 5E9476B2
P 4100 10250
F 0 "#PWR0903" H 4100 10100 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CLCR1:+3.3VF #PWR0908
U 1 1 5E94791E
P 8000 9950
F 0 "#PWR0908" H 8000 9800 50  0001 C CNN
...
U 1 1 5E949139
P 9300 9750
F 0 "#PWR0910" H 9300 9600 50  0001 C CNN
...
U 1 1 5E9493FF
P 9900 10050
F 0 "#PWR0911" H 9900 9900 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CLCR1:+3.3VF #PWR0915
U 1 1 5E9495AA
P 14150 5600
F 0 "#PWR0915" H 14150 5450 50  0001 C CNN
...
$EndComp
$Comp
L ETH1CLCR1:+3.3VF #PWR0905
U 1 1 5E94B0CB
P 7550 3050
F 0 "#PWR0905" H 7550 2900 50  0001 C CNN
